...
from pymoveit2.robots import ur16e
...
class DynamicTrajectoryExecutor(Node):
    ...
    def declare_and_get_parameters(self):
        ...
        self.ur16e_arm = ur_kinematics.URKinematics('ur16e')
    ...
    def setup_moveit2(self, callback_group):
        ...
        self.moveit2 = MoveIt2(
            node=self,
            joint_names=ur16e.joint_names(),
            base_link_name=ur16e.base_link_name(),
            end_effector_name=ur16e.end_effector_name(),
            group_name=ur16e.MOVE_GROUP_ARM,
    ...
    def setup_data_logging(self):
        ...
        # Write CSV header
        header = ["time"] + [f"{joint}_{attr}" for joint in ur16e.joint_names() for attr in ["position", "velocity", "effort"]]
        header += ["force_x", "force_y", "force_z", "torque_x", "torque_y", "torque_z"]
        self.csv_writer.writerow(header)

        # Initialize data storage
        self.joint_data = {name: {"position": None, "velocity": None, "effort": None} for name in ur16e.joint_names()}
    ...
    def joint_state_callback(self, msg):
        ...
        # Prepare row for CSV
        for joint in ur16e.joint_names():
    ...
    def compute_and_execute_trajectory(self, waypoints, dt):
        ...
        current_joints = [current_joint_states[joint]["position"] for joint in ur16e.joint_names()]
        ...
        for i in range(len(waypoints) - 1):
            ...
            for t in range(num_interpolations):
                ...
                joint_positions = self.ur16e_arm.inverse(pose_quat, False, q_guess=current_joints)
                ...
                joint_trajectory.joint_names = ur16e.joint_names()
